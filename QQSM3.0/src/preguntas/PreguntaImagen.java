...
public class PreguntaImagen extends Pregunta {
	...
	/**Constructor que pasa los datos de la pregunta como parametros y ademas pasa la imagen de la pregunta
	 * @param textoPregunta
	 * @param res1
	 * @param res2
	 * @param res3
	...
	public static void main(String[] args) {
		...
		PreguntaImagen pi = new PreguntaImagen("¿Cuál es la capital de Bizkaia?", "Bilbao",
				"Donosti", "Vitoria", "Barcelona", 1, "imagenes\\Jose Tomas Boves.jpg");
